...
public class NiceVideoPlayer extends FrameLayout
     ...
     * 直播
     */
    public static final int MEDIA_TYPE_LIVE = 234;

    /**
     * 录像
     */
    public static final int MEDIA_TYPE_VEDIO = 345;

    private int mMediaType = MEDIA_TYPE_VEDIO;
     ...
     * ijkplayer 参数列表
     */
    private List<IjkOption> ijkOptionArrayList = new ArrayList<>();
    ...
    public List<IjkOption> getIjkOptionArrayList() {
        return ijkOptionArrayList;
    }

    public void setIjkOptionArrayList(List<IjkOption> ijkOptionArrayList) {
        this.ijkOptionArrayList = ijkOptionArrayList;
    }
        ...
        if (mMediaPlayer == null) {
            switch (mPlayerType) {
                ...
                default:
                    ...
                    for (int i = 0; i < ijkOptionArrayList.size(); i++) {
                        IjkOption option = ijkOptionArrayList.get(i);
                        if (option.value instanceof String){
                            ijkMediaPlayer.setOption(option.getCategory(), option.getName(), ((String) option.value));
                        }else {
                            ijkMediaPlayer.setOption(option.getCategory(), option.getName(), ((long) option.value));
                        }
                    }
    ...
    private IMediaPlayer.OnPreparedListener mOnPreparedListener
        ...
        public void onPrepared(IMediaPlayer mp) {
            ...
            if (mMediaType == MEDIA_TYPE_VEDIO) {
                // 从上次的保存位置播放
